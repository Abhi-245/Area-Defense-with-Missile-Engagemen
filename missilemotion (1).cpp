...
#include <scrimmage/plugins/autonomy/missilemotion/missilemotion.h>
...
REGISTER_PLUGIN(scrimmage::Autonomy,
                scrimmage::autonomy::missilemotion,
                missilemotion_plugin)

namespace scrimmage {
namespace autonomy {

void missilemotion::init(std::map<std::string, std::string> &params) {
...
bool missilemotion::step_autonomy(double t, double dt) {
